...
files2 = r'C:\Users\Administrator\Desktop\软工\1\sim_0.8\orig_0.8_del.txt'
aa = SequenceMatcher(None, readLines(files1), readLines(files2)).quick_ratio()
bb = coscompare(files1,files2)
degree = compare(files1, files2)
print(aa)
